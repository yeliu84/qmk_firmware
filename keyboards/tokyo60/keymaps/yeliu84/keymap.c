...
[FN]= LAYOUT_60_hhkb(
    ...
    [L1] = LAYOUT_60_hhkb(
        ...
        KC_TAB,  C(KC_Q),    C(KC_W),   C(KC_E),   C(KC_R),   C(KC_T),   C(KC_Y),   C(KC_U),   C(KC_I),  C(KC_O),     C(KC_P),    SGUI(KC_LBRC), SGUI(KC_RBRC), C(KC_BSLS),      \
    ...
    [L2] = LAYOUT_60_hhkb(
        ...
        _______, _______,       _______,      _______,   S(KC_F6),    A(KC_F12),   _______,      _______,   _______,       _______,        SAG(KC_P),      _______,     _______,  _______,      \
        KC_LCTL, SGUI(KC_A),    SGUI(KC_F),   _______,   A(KC_F1),    _______,     _______,      _______,   AGUI(KC_K),    _______,        _______,        _______,               _______,      \
        _______,                _______,      _______,   LCA(KC_I),   _______,     CGUI(KC_B),   _______,   _______,       AGUI(KC_LEFT),  AGUI(KC_RIGHT), AGUI(KC_F),  _______,  _______, \
             _______, _______,              _______,                         _______, _______
    ),
    [L3] = LAYOUT_60_hhkb(
        KC_ESC,  _______,         _______,      _______,   SCG(KC_4),    SCG(KC_5),      _______,      _______,   _______,       _______,        _______,      _______,  _______,  _______, _______, \
        _______, LCA(KC_Q),       _______,      _______,   A(KC_F11),    SGUI(KC_F12),   _______,      _______,   _______,       _______,        _______,      _______,  _______,  _______,      \
