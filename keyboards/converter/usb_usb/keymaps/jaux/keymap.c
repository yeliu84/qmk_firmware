...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    ______,  ______,     ______,     ______,  ______,                    LCA(KC_SPC),          ______,           ______,              ______,               ______,           MO(_LF2),      ______, ______,           ______, ______, ______,     ______,       ______,______,    ______,______
    ),
