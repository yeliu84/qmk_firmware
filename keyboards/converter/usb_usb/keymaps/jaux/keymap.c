...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    KC_TAB,   ______,  ______,  ______,  LGUI(KC_F6), LALT(KC_F12), ______,  ______,  ______, ______,              SGUI(LALT(KC_P)),     ______,           ______,         SGUI(KC_F12),     ______,RESET, KC_VOLD,    ______,______,______,______,    ______,______,
